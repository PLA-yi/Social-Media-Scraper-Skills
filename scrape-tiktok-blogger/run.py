#!/usr/bin/env python3
"""TikTok 创作者主页爬取 — 调用本地 scraper 服务 API"""
...
def main():
    parser = argparse.ArgumentParser(description="TikTok 创作者主页爬取")
    parser.add_argument("--url", required=True, help="创作者主页链接（支持短链）")
